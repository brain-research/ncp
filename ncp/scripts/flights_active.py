...
def schedule_1(model):
  config = tools.AttrDict()
  config.num_epochs = 10000
  config.num_initial = 10
  config.num_select = 1
  config.select_after_epochs = range(50, 10000, 50)
  config.eval_after_epochs = range(0, 10000, 150)
  config.log_after_epochs = range(0, 10000, 1500)
  config.visualize_after_epochs = range(50, 10000, 2000)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--schedule', default='schedule_10')
